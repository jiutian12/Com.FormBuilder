            ...
            return {
                ...
                controller: ['$scope', function( $scope ) {
                    ...
                    function defaultIsLeaf(node) {
                        if(node.hasOwnProperty('IsHasChild')){
                            return (!node[$scope.options.nodeChildren] || node[$scope.options.nodeChildren].length === 0) && !(node.IsHasChild == 'Y');
                        }
                        else if(node.hasOwnProperty('has_child')){
                            return (!node[$scope.options.nodeChildren] || node[$scope.options.nodeChildren].length === 0) && (node.has_child == '0');
                        }
                    ...
                    $scope.selectNodeLabel2 = function( selectedNode ){
                        
                        if ($scope.onDoubleSelection)
                            $scope.onDoubleSelection();
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<i class="tree-branch-head" ng-class="iBranchClass()"  ng-click="selectNodeLabel(node)"></i>' +
                            '<i class="tree-leaf-head '+classIfDefined($scope.options.injectClasses.iLeaf, false)+'"></i>' +
                            '<div class="tree-label '+classIfDefined($scope.options.injectClasses.label, false)+'" ng-class="selectedClass()" ng-click="selectNodeLabel(node)" ng-dblclick="selectNodeLabel2(node)" tree-transclude></div>' +
