...
; (function (factory) {
    ...
    $.fn.isValid = function (callback, hideMsg) {
        ...
        ret = me._multiValidate(
            ...
            function (isValid) {
                ...
                errors = $.map(me.errors, function (err, key) { return { ele: key, err: err }; });
    ...
    Validator.prototype = {
        ...
        _multiValidateGrid: function (table, keys, datarow, doneCallback) {
            //校验子表grid的方法
            var me = this,
                opt = me.options;
            $.each(keys, function (i, val) {
                me._validateSingle(val, datarow[val]);
        ...
        _validateSingle: function (field, value) {
            var me = this;
            field = field || me.getField(field);
            //获取到rules 和 
            if (!field) return;
