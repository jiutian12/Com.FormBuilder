...
{
    return mxEvent.getSource(evt).nodeName == 'SELECT' || mxEvent.getSource(evt).nodeName == 'TEXTAREA' || (mxEvent.getSource(evt).nodeName == 'INPUT' &&
...
EditorUi.prototype.open = function()
{
   ...
   // mxEditor
 //   var doc = mxUtils.parseXml(VisioController.getXML()); 
	...
	if (name != null)
	{
		...
		try
		{
			...
			else
			{
				...
				{
                    VisioController.saveConfig(xml);
				}
				else
				{
